...
{
    return ['+' => 'ADD', '-' => 'MINUS', '*' => 'multiply', '/' => 'division', 'sqr' => 'sqr', 'cubeRoot' => 'cubeRoot', 'twice' => 'twice', 'circle' => 'circle' , 'pow' => '**'];
}
...
function PowerCanNotBeZero($num1 , $sign)
{
    if ($num1 == 0 && $sign == "**") {
        throw new Exception("can't divide by zero");
    }
